...
#wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj900judgehost.sh
...
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj900start.sh
