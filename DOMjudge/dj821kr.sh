...
sudo sed -i "s/preliminary results - not final/가채점 결과 - 최종 결과 아님/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
sudo sed -i "s/final standings/최종 순위/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
sudo sed -i "s/contest over, waiting for results/대회 종료됨, 최종 결과 확인중/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
...
sudo sed -i "s/minutes remaining - solutions/분전에 스코어보드가 변하지 않게 고정(frozen)되었습니다. -/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
sudo sed -i "s/submitted in the last/대회 종료/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
sudo sed -i "s/minutes of the contest/분전 스코어보드 고정(frozen) 이후에 제출된 것들은/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
sudo sed -i "s/are still shown as pending/제출된 것으로만 보입니다./" /opt/domjudge/domserver/webapp/templates/partials/scoreboard.html.twig
...
sudo sed -i "s/total solved/맞은 개수/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_summary.html.twig
sudo sed -i "s/number of accepted submissions/맞음/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_summary.html.twig
...
sudo sed -i "s/number of pending submissions/제출됨/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_summary.html.twig
sudo sed -i "s/first solved/처음 맞은 시간/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_summary.html.twig
...
sudo sed -i "s/solved \/ penalty time/맞음 \/ 시간 패널티/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
sudo sed -i "s/>score/>점수/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
sudo sed -i "s/Solved first/가장 먼저 맞음/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
sudo sed -i "s/Solved/맞음/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
sudo sed -i "s/Tried, incorrect/틀림/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
sudo sed -i "s/Tried, pending/채점 제출됨/" /opt/domjudge/domserver/webapp/templates/partials/scoreboard_table.html.twig
...
sudo sed -i "s/Send clarification request/명확한 설명 요청/" /opt/domjudge/domserver/webapp/templates/team/clarification_add_modal.html.twig
