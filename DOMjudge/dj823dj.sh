...
#2025.5 Made by melongist(melongist@gmail.com) for CS teachers
#DOMjudge8.2.3 stable + Ubuntu 22.04.4 LTS + apache2/nginx

#terminal commands to install DOMjudge server
#------
#wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823dj.sh
#bash dj823dj.sh


if [[ $SUDO_USER ]] ; then
  echo ""
  echo "Just use 'bash dj823dj.sh'"
  exit 1
fi
...
#DOMjudge 8.2.3 stable
#wget https://www.domjudge.org/releases/domjudge-8.2.3.tar.gz
#tar xvf domjudge-8.2.3.tar.gz
#cd domjudge-8.2.3
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/domjudge-8.2.3.tar.gz
tar xvf domjudge-8.2.3.tar.gz
rm domjudge-8.2.3.tar.gz
cd domjudge-8.2.3
...
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823jh.sh
#wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823kr.sh
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823start.sh
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823clear.sh
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823mas.sh
