...
#------
#wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj813djn.sh
#bash dj813djn.sh
...
if [[ $SUDO_USER ]] ; then
  echo "Just use 'bash dj813djn.sh'"
  exit 1
fi
...
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj813mas.sh
