...
#wget https://www.domjudge.org/releases/domjudge-8.1.0.tar.gz
#tar xvf domjudge-8.1.0.tar.gz
#cd domjudge-8.1.0

#DOMjudge 8.1.0 stable
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/domjudge-8.1.0.tar.gz
tar xvf domjudge-8.1.0.tar.gz
rm domjudge-8.1.0.tar.gz
cd domjudge-8.1.0
...
echo "DOMjudge 8.1.0 stable 22.06.06" | tee -a domjudge.txt
echo "" | tee -a domjudge.txt
...
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj810kr.sh
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj810start.sh
wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj810clear.sh
