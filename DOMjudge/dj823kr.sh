...
#------
#wget https://raw.githubusercontent.com/melongist/CSL/master/DOMjudge/dj823kr.sh
#bash dj823kr.sh


if [[ $SUDO_USER ]] ; then
  echo "Just use 'bash dj823kr.sh'"
  exit 1
fi
...
echo "DOMjudge 8.2.3 stable 24.02.28" | tee -a ~/domjudge.txt
