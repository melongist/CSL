  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <form action="modify.php" method="post" role="form" class="form-horizontal">
        ...
        <!-- + by CSL -->
        <div class="form-group">
          <label class="col-sm-4 control-label"><?php echo "개인정보 수집동의"?></label>
          <label class="col-sm-3"><?php echo "개인정보처리방침에 의한 개인정보 수집을 동의합니다."?></label>
          <div class="col-sm-1"><input name="privacy_check" class="form-check-input" type="checkbox"></div>
        </div>
        <!-- + by CSL -->
