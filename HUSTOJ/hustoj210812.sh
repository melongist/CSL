...
THISFILE="hustoj21812.sh"
SRCZIP="hustoj210812.zip"
DOCKERFILE="Dockerfile210812"
...
apt -y install apt-transport-https ca-certificates curl gnupg-agent lsb-release software-properties-common
