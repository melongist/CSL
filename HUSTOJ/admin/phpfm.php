...
class config {
    ...
    if($OJ_LANG == "ko" ) $this->data['lang']="ko";
    }
    function save(){
...
function et($tag){
    ...
    $ko['Version'] = '버전';
    $ko['DocRoot'] = '호스트 루트 디렉토리';
    $ko['FMRoot'] = '관리하려는 디렉토리';
    $ko['DateFormat'] = '날짜 형식';
    $ko['GetSize'] = '크기 계산';
    $ko['Error'] = '오류';
    $ko['Name'] = '이름';
    ...
    $ko['Dir_s'] = '개의 디렉토리';
    $ko['To'] = '에서';
    $ko['Destination'] = '대상 디렉토리';
    $ko['Configurations'] = '설정';
    $ko['JSError'] = '스크립트 오류';
    $ko['NoSel'] = '선택한 항목이 없습니다';
    $ko['SelDir'] = '왼쪽 목록에서 대상 디렉토리를 선택해주세요';
    $ko['TypeDir'] = '디렉토리 이름을 입력해주세요';
    $ko['TypeArq'] = '파일 이름을 입력해주세요';
    $ko['TypeCmd'] = '명령어를 입력해주세요';
    $ko['TypeArqComp'] = '압축파일 이름을 입력해 주시면, 확장자에 맞는 형식으로 압축합니다.\\n\\n확장자 예시:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $ko['RemSel'] = '선택한 항목을 삭제하시겠습니까';
    $ko['NoDestDir'] = '선택한 대상 디렉토리가 없습니다';
    $ko['DestEqOrig'] = '원본 디렉토리와 대상 디렉토리가 동일합니다';
    $ko['InvalidDest'] = '대상 디렉토리가 올바르지 않습니다';
    $ko['NoNewPerm'] = '권한이 설정되지 않았습니다';
    $ko['CopyTo'] = '여기에 복사하시겠습니까';
    $ko['MoveTo'] = '여기로 이동하시겠습니다';
    $ko['AlterPermTo'] = '권한을 다음으로 변경하시겠습니까';
    $ko['ConfExec'] = '다음을 실행하시겠습니까';
    $ko['ConfRem'] = '다음을 삭제하시겠습니까';
    $ko['EmptyDir'] = '디렉토리가 비었습니다';
    $ko['IOError'] = '입출력 오류가 발생했습니다';
    $ko['FileMan'] = 'PHP 파일 관리자';
    $ko['InvPass'] = '패스워드가 올바르지 않습니다';
    $ko['ReadDenied'] = '파일을 읽을 수 없습니다';
    $ko['FileNotFound'] = '파일을 찾을 수 없습니다';
    $ko['AutoClose'] = '완료 후 닫기';
    $ko['OutDocRoot'] = '접근 가능한 디렉토리 범위를 벗어났습니다';
    $ko['NoCmd'] = '오류: 명령어가 올바르지 않습니다';
    $ko['ConfTrySave'] = '파일에 쓰기 권한이 없습니다.\\n그래도 저장을 시도하시겠습니까';
    $ko['ConfSaved'] = '설정을 저장했습니다';
    $ko['PassSaved'] = '패스워드를 저장했습니다';
    $ko['FileDirExists'] = '이미 존재하는 파일 또는 디렉토리 이름입니다';
    $ko['NoPhpinfo'] = 'phpinfo 함수를 사용할 수 없습니다';
    $ko['NoReturn'] = '결과가 없습니다';
    $ko['FileSent'] = '파일을 전송했습니다';
    $ko['SpaceLimReached'] = '용량 제한을 초과했습니다';
    $ko['InvExt'] = '확장자가 올바르지 않습니다';
    $ko['FileNoOverw'] = '파일을 덮어쓸 수 없습니다';
    $ko['FileOverw'] = '파일을 덮어썼습니다';
    $ko['FileIgnored'] = '파일을 건너뛰었습니다';
    $ko['ChkVer'] = '새로운 버전 확인';
    $ko['ChkVerAvailable'] = '여기를 클릭하셔서 새로운 버전을 다운로드 하세요!';
    $ko['ChkVerNotAvailable'] = '새로운 버전이 없습니다. :(';
    $ko['ChkVerError'] = '연결에 실패했습니다';
    $ko['Website'] = '웹사이트';
    $ko['SendingForm'] = '파일을 전송하고 있습니다. 잠시만 기다려주세요';
    $ko['NoFileSel'] = '선택한 파일이 없습니다';
    $ko['SelAll'] = '전체선택';
    $ko['SelNone'] = '선택해제';
    $ko['SelInverse'] = '선택반전';
    $ko['Selected_s'] = '선택됨';
    $ko['Total'] = '전체';
    $ko['Partition'] = '파티션';
    $ko['RenderTime'] = '페이지 처리 시간';
    $ko['Seconds'] = '초';
    $ko['ErrorReport'] = '오류 출력';
    $ko['Close'] = '닫기';
    $ko['SetPass'] = '패스워드 설정';
    $ko['ChangePass'] = '패스워드 변경';
    $ko['Portscan'] = '포트스캔';
    $ko['PHPOpenBasedir'] = '접근 가능한 디렉토리';
    $ko['PHPOpenBasedirFullAccess'] = '(미설정) 전체 접근 가능';
    $ko['About'] = '소개';
    $ko['FileSaved'] = '파일을 저장했습니다';
    $ko['FileSaveError'] = '파일 저장 중 오류가 발생했습니다';
    $ko['Timezone'] = '시간대';
    $ko['Stop'] = '정지';
    $ko['Login'] = '로그인';
