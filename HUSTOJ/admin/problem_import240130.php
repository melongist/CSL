  ...
  <div class="container">
    ...
    <form class='form-inline' action='problem_import_xml.php' method=post enctype="multipart/form-data">
      <div class='form-group'>
        ...
        <!-- * by CSL -->
        <button class='btn btn-default btn-sm' type=submit>Upload problems only to CSL HUSTOJ</button>
      </div>
...
- Import Problem from QDUOJ - json - zip<br>应该是真的QDUOJ，未严格测试，感谢[温十六中]吴晓阳提供例子文件<br>
    ...
    <!-- * by CSL -->
    <?php if ($OJ_LANG == "ko") { ?>
    CSL HUSTOJ의 문제 XML은 서로 호환됩니다.<br>
    직접 만들거나, 수정한 문제를 서로 나눔할 수 있습니다.<br>
    <?php } ?>
